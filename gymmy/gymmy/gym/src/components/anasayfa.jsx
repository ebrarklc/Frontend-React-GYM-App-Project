...
const OurTeam = () => {
  ...
  const Gallery = () => {
    return (
        <>
      <GalleryContainer>
        <h1 style={{ textAlign: "center"}}>GYMMY</h1>
        <br/>
        <ImagesGrid>
          {[
            i11, i2, i9, 
